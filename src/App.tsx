...
const projects: ProjectData[] = [
  {
    ...
    desc: 'A modular planning platform built for real-world use. Clean dashboard, user auth, and a growing suite of tools — wishlist sharing, tournament management, and more — all under one custom domain.',
    ...
    img2: 'https://images.unsplash.com/photo-1557838923-2985c318be48?w=600&q=80',
    img3: 'https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=900&q=80',
  },
  {
    num: '02',
    title: 'Planary Wishlist',
    category: 'Full-Stack App',
    desc: 'Wishlist sharing app hosted at wishlist.planary.ch. React + Vite frontend, Go backend deployed as serverless functions, PostgreSQL for storage. Secure auth via HTTP-only cookies, shareable links per user.',
    tags: ['React', 'Go', 'PostgreSQL', 'Vite', 'JWT Auth'],
    href: 'https://wishlist.planary.ch',
    img1: 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?w=600&q=80',
    img2: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=600&q=80',
    img3: 'https://images.unsplash.com/photo-1512909006721-3d6018887383?w=900&q=80',
  },
  {
    num: '03',
    title: 'Planary Tournament',
    category: 'Platform',
    desc: 'Tournament management at tournament.planary.ch. Organizers build brackets and manage rosters across group stage, knockout, and hybrid formats. Players follow standings and results in real time.',
  ...
  },
  {
    ...
    desc: 'Property portal at milla-homes.com. Public listings with search and category filtering, individual property pages with contact forms, and a password-protected admin panel for managing inventory and availability.',
