export const DATA = {
  ...
  techStack: [
    ...
    { cat: 'Mobile',    items: ['Swift', 'SwiftUI', 'Xcode'] },
    { cat: 'Backend',   items: ['Go', 'Hono', 'Java', 'Python', 'C#', 'PHP'] },
...
export const TECH_CONFIG: Record<string, { icon: string; projects: { name: string; url: string }[] }> = {
  ...
  TypeScript:   { icon: 'typescript',   projects: [{ name: 'Milla Homes', url: 'https://milla-homes.com' }, { name: 'AutoBot Dashboard', url: 'https://autobot-dashboard.vercel.app' }, { name: 'refind', url: 'https://github.com/Fallka0/refind' }] },
  Vercel:       { icon: 'vercel',       projects: [{ name: 'Milla Homes', url: 'https://milla-homes.com' }, { name: 'AutoBot Dashboard', url: 'https://autobot-dashboard.vercel.app' }, { name: 'refind', url: 'https://github.com/Fallka0/refind' }] },
  ...
  PostgreSQL:   { icon: 'postgresql',   projects: [{ name: 'Planary', url: 'https://planary.ch' }, { name: 'refind', url: 'https://github.com/Fallka0/refind' }] },
  ...
  Docker:       { icon: 'docker',       projects: [{ name: 'Planary', url: 'https://planary.ch' }, { name: 'refind', url: 'https://github.com/Fallka0/refind' }] },
  Git:          { icon: 'git',          projects: [{ name: 'Planary', url: 'https://planary.ch' }, { name: 'Milla Homes', url: 'https://milla-homes.com' }, { name: 'refind', url: 'https://github.com/Fallka0/refind' }] },
  ...
  Swift:        { icon: 'swift',        projects: [{ name: 'refind', url: 'https://github.com/Fallka0/refind' }] },
  SwiftUI:      { icon: '',             projects: [{ name: 'refind', url: 'https://github.com/Fallka0/refind' }] },
  Xcode:        { icon: 'xcode',        projects: [{ name: 'refind', url: 'https://github.com/Fallka0/refind' }] },
  Hono:         { icon: 'hono',         projects: [{ name: 'refind', url: 'https://github.com/Fallka0/refind' }] },
